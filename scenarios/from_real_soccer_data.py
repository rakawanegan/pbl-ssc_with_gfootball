...
def build_scenario(builder):
	...
	builder.AddPlayer(0.100000, 0.214076, e_PlayerRole_CB )
	...
	builder.AddPlayer(0.064000, -0.059912, e_PlayerRole_DM )
	builder.AddPlayer(0.174286, 0.015812, e_PlayerRole_DM )
	builder.AddPlayer(0.242286, -0.160712, e_PlayerRole_CB )
	...
	builder.AddPlayer(0.150286, -0.107100, e_PlayerRole_DM )
	builder.AddPlayer(-0.006286, -0.113524, e_PlayerRole_CF )
	builder.AddPlayer(0.185333, -0.290047, e_PlayerRole_CF )
	builder.AddPlayer(0.097905, 0.190729, e_PlayerRole_DM )
	...
	builder.AddPlayer(0.308952, 0.141071, e_PlayerRole_CB )
	builder.AddPlayer(0.400381, -0.150088, e_PlayerRole_CB )
	builder.AddPlayer(0.383238, -0.294000, e_PlayerRole_CB )
