...
def main(cfg):
    ...
    print(
        f"[info] Results of Winning rate: {results.count('Home') / cfg.n_iter * 100:.2f}% Home, {results.count('Away') / cfg.n_iter * 100:.2f}% Away, {results.count('Draw') / cfg.n_iter * 100:.2f}% Draw"
    )
